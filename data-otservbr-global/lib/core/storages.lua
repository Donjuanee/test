...
Storage = {
	Custom = {
		BeginnersTrials = {
			Questline = 55000, -- 1 = started
			Stage = 55001, -- 0 = not started, 1 = in progress, 2 = completed (return), 3 = rewarded
			Kills = 55002, -- kill counter
			AttributePoints = 55003, -- +2 AP reward (integrate with your AP system if needed)
			RotwormTrouble = 55004, -- 0 not started, 1 in progress, 2 return, 3 rewarded
			LegionHelmet = 55005, -- 0 not started, 1 in progress, 2 ready to reward, 3 rewarded
		},
	},
